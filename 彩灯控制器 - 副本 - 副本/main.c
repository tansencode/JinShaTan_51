...
/*void Led1()
{
    static unsigned char cnt = 0; //动态扫描的索引
    //P0 = 0xFF; //显示消隐
    switch (cnt)
    {
       case 0: ADDR2=1; ADDR1=1; ADDR0=0; cnt++; P0=L1[0]; break;
      // case 1: ADDR2=1; ADDR1=1; ADDR0=0; cnt++; P0=L1[1]; break;
      // case 2: ADDR2=1; ADDR1=1; ADDR0=0; cnt++; P0=L1[2]; break;
      // case 3: ADDR2=1; ADDR1=1; ADDR0=0; cnt++; P0=L1[3]; break;
      // case 4: ADDR2=1; ADDR1=1; ADDR0=0; cnt++; P0=L1[4]; break;
      // case 5: ADDR2=1; ADDR1=1; ADDR0=0; cnt=0; P0=L1[5]; break;
       default: break;
   }
}	  */
/*void dianscan()
