...
extern void  InitLed();
extern void  InitDS1302();     //初始化实时时钟模块    
extern void  InitInfrared();   //初始化红外接收模块
extern void  InitLcd1602();    //初始化液晶模块
extern void  Start18B20();     //启动首次温度转换
extern void  KeyScan();   //执行按键扫描
extern void  RefreshTime();    //刷新当前时间
extern void  RefreshDate(1);   //立即刷新日期显示
