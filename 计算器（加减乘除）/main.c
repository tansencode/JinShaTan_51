...
static unsigned long num=0,num1=0,num2=0; //用于保存输入的数
static int i=0;
{
...
else if (keycode == 0x26) //用作加号，执行加法或连加运算
{
i=1;
num1=num;
num=0;
...
else if (keycode == 0x28) //用作减号，执行减法或连减运算
{
i=2;
num1=num;
num=0;
...
else if (keycode == 0x25) //用作乘号，执行乘法或连乘运算
{
i=3;
num1=num;
num=0;
}
else if (keycode == 0x27) //用作除号，执行除法或连除运算
{
i=4;
num1=num;
num=0;
...
else if(keycode==0x0D)
{
	...
	switch(i)
	{
	case 1:result=num1+num2;ShowNumber(result);break;
	case 2:result=num1-num2;ShowNumber(result);break;
	case 3:result=num1*num2;ShowNumber(result);break;
	case 4:result=num1/num2;ShowNumber(result);break;
	default:
	break;
	}
}
else if (keycode == 0x1B) //Esc 键，执行清零结果
{
num = 0;
result = 0;
