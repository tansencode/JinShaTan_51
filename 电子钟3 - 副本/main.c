...
void IncSetTime()
{
    switch (setIndex)
    {
        ...
        case 1:  bufTime.hour = IncBcdHigh(bufTime.hour); break;
        case 2:  bufTime.hour = IncBcdLow(bufTime.hour);  break;
        case 3:  bufTime.min  = IncBcdHigh(bufTime.min);  break;
        case 4:  bufTime.min  = IncBcdLow(bufTime.min);   break;
        case 5:  bufTime.sec  = IncBcdHigh(bufTime.sec);  break;
        case 6:  bufTime.sec  = IncBcdLow(bufTime.sec);   break;
        default:  break;
    }
    //RefreshTimeShow();
	//RefreshTimeShow();
...
void DecSetTime()
{
    switch (setIndex)
    {
        ...
        case 1:  bufTime.hour = DecBcdHigh(bufTime.hour); break;
        case 2:  bufTime.hour = DecBcdLow(bufTime.hour);  break;
        case 3:  bufTime.min  = DecBcdHigh(bufTime.min);  break;
        case 4:  bufTime.min  = DecBcdLow(bufTime.min);   break;
        case 5:  bufTime.sec  = DecBcdHigh(bufTime.sec);  break;
        case 6:  bufTime.sec  = DecBcdLow(bufTime.sec);   break;
        default:  break;
    }
    //RefreshTimeShow();
	//RefreshTimeShow();
